...
```{r create_dataset}
# Using set.seed(4) ensures the result is reproducible. The random number 
# generator can vary between operating systems, so maybe there will be
#different datasets in the classroom
